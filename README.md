...
ActiveORM is a Java ORM framework for Mysql(Just now,only support mysql).Well,the core is still Hiberate.But with wraper of ActiveORM,
Hibernate is so sexy!
Real ActiveRecord in Java 
...
```java
        ...
        // Actually this means you should put your datasource configuration in a yaml file.And then load it
